...
for ipass=1:2;
  ...
  if ipass==1; 
    ...
    print -dpng solution_n10_nc4.png
  end;
  ...
  for mg_iter=1:10;
    ...
    caption = [int2str([mg_iter N Nc]) ' Two-Level Error, e_{inf} = ' num2str(emx)];
    figure; se_mesh(X,Y,err,caption);
    if mg_iter==8;  print -dpng iter_08_n10_nc4_cheb.png; end;
    if mg_iter==9;  print -dpng iter_09_n10_nc4_cheb.png; end;
    if mg_iter==10; print -dpng iter_10_n10_nc4_cheb.png; end;
