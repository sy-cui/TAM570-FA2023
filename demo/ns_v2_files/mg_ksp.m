function [x,iter,itcc,res,timer]=mg_ksp(Fl,lam_max,tol,max_iter,h0,h1,M,Q,Bl,Grr,Grs,Gss,Dh,dA,ifnull,...
                              Jc,Mc,Qc,Blc,Grrc,Grsc,Gssc,Dc,dAc,Ue,X,Y,timer);
...
rho1=1; rtz1=1; r=Fl; x=0*r; p=x; itcc=0;
for iter=1:max_iter;

   [z,itc,rz]=cheb4_vcyc(r,1,2,lam_max,h0,h1,M,Q,Bl,Grr,Grs,Gss,Dh,dA,ifnull,...
